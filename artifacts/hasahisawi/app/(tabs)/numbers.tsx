...
const CATEGORIES: Category[] = [
  {
    ...
    color: "#EF4444",
    numbers: [
      { id: "police",    name: "الشرطة",            number: "999",  icon: "shield",           color: "#3B82F6", note: "متاح 24 ساعة" },
      { id: "ambulance", name: "الإسعاف",            number: "998",  icon: "medkit",           color: "#EF4444", note: "متاح 24 ساعة" },
      { id: "fire",      name: "الدفاع المدني والإطفاء", number: "998",  icon: "flame",        color: "#F97316", note: "متاح 24 ساعة" },
    ],
  },
  {
    id: "health",
    ...
    color: "#2D8A96",
    numbers: [
      { id: "hospital",  name: "مستشفى الحصاحيصا الحكومي", number: "0151234567", icon: "hospital",     color: "#2D8A96", note: "7ص – 5م" },
      { id: "clinic1",   name: "عيادة الطوارئ المركزية",   number: "0152345678", icon: "pulse",        color: "#10B981", note: "24 ساعة" },
      { id: "pharmacy",  name: "صيدلية الإسعاف",           number: "0153456789", icon: "flask",        color: "#8B5CF6", note: "24 ساعة" },
    ],
  },
  {
    id: "services",
    ...
    color: "#E07830",
    numbers: [
      { id: "water",    name: "مياه الشرب",     number: "0154567890", icon: "water",        color: "#06B6D4" },
      { id: "electric", name: "الكهرباء",       number: "0155678901", icon: "flash",        color: "#EAB308" },
      { id: "roads",    name: "إدارة الطرق",    number: "0156789012", icon: "car",          color: "#F97316" },
      { id: "sanit",    name: "النظافة والصرف", number: "0157890123", icon: "trash",        color: "#4A7459" },
    ],
  },
  {
    id: "government",
    ...
    color: "#6366F1",
    numbers: [
      { id: "locality",  name: "مفوضية المحلية",    number: "0158901234", icon: "business",     color: "#6366F1" },
      { id: "civil",     name: "السجل المدني",      number: "0159012345", icon: "card",         color: "#E07830" },
      { id: "courts",    name: "المحكمة",           number: "0150123456", icon: "library",      color: "#C4643A" },
      { id: "taxauth",   name: "الضرائب والجمارك", number: "0151234560", icon: "receipt",      color: "#8B5CF6" },
    ],
  },
  {
    id: "education",
    ...
    color: "#8B5CF6",
    numbers: [
      { id: "edu1",  name: "إدارة التعليم بالمنطقة", number: "0152345679", icon: "school",       color: "#8B5CF6" },
      { id: "edu2",  name: "امتحانات الشهادة السودانية", number: "0153456780", icon: "document-text", color: "#EC4899" },
    ],
  },
];
